...
$query="select * from order_info order by order_no desc;";
					...
					<table class="table table-hover" style="color:#cb202d;border:1;">
						...
						<tbody style="color:black;">
							<tr>
									...
									<td>
										<?php echo $rec['total_amount'] ?>
									</td>
									<td>
										<?php echo $rec['time'] ?>
									</td>
                                                                        <td>
                                                                                  <button class="js-click" onclick="style='background-color: green;'"  style="background-color: #cb202d;  " > DELIVERED </button>
